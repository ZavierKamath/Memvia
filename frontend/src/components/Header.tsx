...
function OpenPDF() {
	...
	return (
		<div>
			...
			{opened ?
				<div className="fixed top-16 right-20 px-6 py-6 border-2 border-highlight shadow-md shadow-black/100 rounded-xl bg-bg-dark">
...
export function Header() {
	...
	return (
		<header className="px-8 py-4 col-span-2 bg-bg text-text flex justify-between items-center">
			<h1 className="text-xl border-2 border-b-4 border-primary px-2 py-1 rounded-xl"> 
